    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                wordScore = getWordScore(inputWord, n)
                totalScore += wordScore
                print("\"", inputWord, "\" earned ", str(wordScore), " points. Total: ", str(totalScore), " points.")
                print()
                # Update the hand 
...
def playGame(wordList):
    ...
    while not done:
        while not validOption:
            print("Enter n to deal a new hand,", end=" ")
            print(" r to replay the last hand,", end=" ")
            option = input("or e to end game: ")
            if option not in "nre":
                print("Invalid Comand")
            elif option == "r" and not hand:
